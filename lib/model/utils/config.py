...
def cfg_from_file(filename):
  ...
  with open(filename, 'r') as f:
    # PyYAML >= 5.1 บังคับให้ระบุ Loader ชัดเจน (เพื่อความปลอดภัย, กัน
    # arbitrary code execution จาก yaml.load แบบไม่ระบุ Loader) - โค้ดเดิม
    # (~2018) เขียนก่อนมีข้อบังคับนี้ ใช้ FullLoader เพราะพฤติกรรมใกล้เคียง
    # ค่า default เดิมที่สุด (รองรับ python object ทั่วไปแต่ไม่รัน arbitrary code)
